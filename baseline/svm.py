...
def baseline(path, outpath, n=3, ft=5, pt=0.1):
    ...
    for index, problem in enumerate(problems[:]):
        ...
        vectorizer = CountVectorizer(stop_words=language, analyzer='char', ngram_range=(1, 10), lowercase=False, vocabulary=vocabulary)
...
if __name__ == '__main__':
    main()
    # baseline("/Users/valerioneri/Sapienza/Projects/Authorship/Datasets/training-dataset-2019-01-23", "/Users/valerioneri/Sapienza/Projects/Authorship/Code/baseline/my_outs")
